...
2. Open Live Server and navigate from your home page to your portfolio to view your changes in real time.

3. Scroll down to the section where you added your FSD project links. It should look something like this, but with your actual project names and links:
...
```bash
git add .
git commit -m "Added links to ASD projects in portfolio"
git push
```